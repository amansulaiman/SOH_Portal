...
namespace Grading_SOH_Final_Rel.Controllers
{
    ...
    public class SessionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SessionID,SessionName")] Session session)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SessionID,SessionName")] Session session)
        {
            if (ModelState.IsValid)
            {
